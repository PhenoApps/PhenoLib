...
public class ObservationSummary implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.collector == null ? observationSummary.collector == null : this.collector.equals(observationSummary.collector)) &&
        (this.observationDbId == null ? observationSummary.observationDbId == null : this.observationDbId.equals(observationSummary.observationDbId)) &&
        (this.observationTimeStamp == null ? observationSummary.observationTimeStamp == null : this.observationTimeStamp.equals(observationSummary.observationTimeStamp)) &&
        (this.observationVariableDbId == null ? observationSummary.observationVariableDbId == null : this.observationVariableDbId.equals(observationSummary.observationVariableDbId)) &&
        (this.observationVariableName == null ? observationSummary.observationVariableName == null : this.observationVariableName.equals(observationSummary.observationVariableName)) &&
        (this.value == null ? observationSummary.value == null : this.value.equals(observationSummary.value));
  }
