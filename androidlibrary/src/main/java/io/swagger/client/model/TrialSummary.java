...
public class TrialSummary implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.active == null ? trialSummary.active == null : this.active.equals(trialSummary.active)) &&
        (this.additionalInfo == null ? trialSummary.additionalInfo == null : this.additionalInfo.equals(trialSummary.additionalInfo)) &&
        (this.endDate == null ? trialSummary.endDate == null : this.endDate.equals(trialSummary.endDate)) &&
        (this.programDbId == null ? trialSummary.programDbId == null : this.programDbId.equals(trialSummary.programDbId)) &&
        (this.programName == null ? trialSummary.programName == null : this.programName.equals(trialSummary.programName)) &&
        (this.startDate == null ? trialSummary.startDate == null : this.startDate.equals(trialSummary.startDate)) &&
        (this.studies == null ? trialSummary.studies == null : this.studies.equals(trialSummary.studies)) &&
        (this.trialDbId == null ? trialSummary.trialDbId == null : this.trialDbId.equals(trialSummary.trialDbId)) &&
        (this.trialName == null ? trialSummary.trialName == null : this.trialName.equals(trialSummary.trialName));
  }
