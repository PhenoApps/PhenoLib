...
public class VendorSample implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.column == null ? vendorSample.column == null : this.column.equals(vendorSample.column)) &&
        (this.concentration == null ? vendorSample.concentration == null : this.concentration.equals(vendorSample.concentration)) &&
        (this.row == null ? vendorSample.row == null : this.row.equals(vendorSample.row)) &&
        (this.sampleDbId == null ? vendorSample.sampleDbId == null : this.sampleDbId.equals(vendorSample.sampleDbId)) &&
        (this.taxonId == null ? vendorSample.taxonId == null : this.taxonId.equals(vendorSample.taxonId)) &&
        (this.tissueType == null ? vendorSample.tissueType == null : this.tissueType.equals(vendorSample.tissueType)) &&
        (this.volume == null ? vendorSample.volume == null : this.volume.equals(vendorSample.volume)) &&
        (this.well == null ? vendorSample.well == null : this.well.equals(vendorSample.well));
  }
