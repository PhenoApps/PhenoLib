...
public class ObservationUnitPhenotype implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.X == null ? observationUnitPhenotype.X == null : this.X.equals(observationUnitPhenotype.X)) &&
        (this.Y == null ? observationUnitPhenotype.Y == null : this.Y.equals(observationUnitPhenotype.Y)) &&
        (this.blockNumber == null ? observationUnitPhenotype.blockNumber == null : this.blockNumber.equals(observationUnitPhenotype.blockNumber)) &&
        (this.entryNumber == null ? observationUnitPhenotype.entryNumber == null : this.entryNumber.equals(observationUnitPhenotype.entryNumber)) &&
        (this.entryType == null ? observationUnitPhenotype.entryType == null : this.entryType.equals(observationUnitPhenotype.entryType)) &&
        (this.germplasmDbId == null ? observationUnitPhenotype.germplasmDbId == null : this.germplasmDbId.equals(observationUnitPhenotype.germplasmDbId)) &&
        (this.germplasmName == null ? observationUnitPhenotype.germplasmName == null : this.germplasmName.equals(observationUnitPhenotype.germplasmName)) &&
        (this.observationLevel == null ? observationUnitPhenotype.observationLevel == null : this.observationLevel.equals(observationUnitPhenotype.observationLevel)) &&
        (this.observationLevels == null ? observationUnitPhenotype.observationLevels == null : this.observationLevels.equals(observationUnitPhenotype.observationLevels)) &&
        (this.observationUnitDbId == null ? observationUnitPhenotype.observationUnitDbId == null : this.observationUnitDbId.equals(observationUnitPhenotype.observationUnitDbId)) &&
        (this.observationUnitName == null ? observationUnitPhenotype.observationUnitName == null : this.observationUnitName.equals(observationUnitPhenotype.observationUnitName)) &&
        (this.observationUnitXref == null ? observationUnitPhenotype.observationUnitXref == null : this.observationUnitXref.equals(observationUnitPhenotype.observationUnitXref)) &&
        (this.observations == null ? observationUnitPhenotype.observations == null : this.observations.equals(observationUnitPhenotype.observations)) &&
        (this.plantNumber == null ? observationUnitPhenotype.plantNumber == null : this.plantNumber.equals(observationUnitPhenotype.plantNumber)) &&
        (this.plotNumber == null ? observationUnitPhenotype.plotNumber == null : this.plotNumber.equals(observationUnitPhenotype.plotNumber)) &&
        (this.programName == null ? observationUnitPhenotype.programName == null : this.programName.equals(observationUnitPhenotype.programName)) &&
        (this.replicate == null ? observationUnitPhenotype.replicate == null : this.replicate.equals(observationUnitPhenotype.replicate)) &&
        (this.studyDbId == null ? observationUnitPhenotype.studyDbId == null : this.studyDbId.equals(observationUnitPhenotype.studyDbId)) &&
        (this.studyLocation == null ? observationUnitPhenotype.studyLocation == null : this.studyLocation.equals(observationUnitPhenotype.studyLocation)) &&
        (this.studyLocationDbId == null ? observationUnitPhenotype.studyLocationDbId == null : this.studyLocationDbId.equals(observationUnitPhenotype.studyLocationDbId)) &&
        (this.studyName == null ? observationUnitPhenotype.studyName == null : this.studyName.equals(observationUnitPhenotype.studyName)) &&
        (this.treatments == null ? observationUnitPhenotype.treatments == null : this.treatments.equals(observationUnitPhenotype.treatments));
  }
