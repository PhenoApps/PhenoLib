...
public abstract class ItemActivity extends Activity
{
    ...
    @androidx.annotation.Nullable final android.os.Bundle savedInstanceState)
    {
        ...
        this.setContentView(org.phenoapps.androidlibrary.R.layout.mstrdtl_item_activity);
        ...
        this.collapsingToolbarLayout = this.findViewById(
            org.phenoapps.androidlibrary.R.id.masterDetailItemCollapsingToolbarLayout);
        ...
        if (null == savedInstanceState)
        {
            ...
            this.setAndAddItemFragment(
                org.phenoapps.androidlibrary.R.id.masterDetailNestedScrollView, itemFragment);
        }
    }
