...
public abstract class ListActivity extends Activity
{
    ...
    final ItemFragment itemFragment)
    {
        this.setAndReplaceItemFragment(
            org.phenoapps.androidlibrary.R.id.content_container, itemFragment);
    }
    ...
    @androidx.annotation.Nullable final android.os.Bundle savedInstanceState)
    {
        ...
        this.setContentView(org.phenoapps.androidlibrary.R.layout.mstrdtl_list_activity);

        {
            ...
            final boolean twoPane = null != this.findViewById(
                org.phenoapps.androidlibrary.R.id.content_container);    // From layout-w900dp-
        ...
        }
        {
            final androidx.recyclerview.widget.RecyclerView recyclerView = this.findViewById(
                org.phenoapps.androidlibrary.R.id.masterDetailRecyclerView);
