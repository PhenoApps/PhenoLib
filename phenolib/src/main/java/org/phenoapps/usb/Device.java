...
public class Device extends java.lang.Object
{
    ...
    static class UsbDeviceIsNull extends org.phenoapps.usb.Device.Exception
    {
                UsbDeviceIsNull(final java.lang.String message) { super(message); }
        private UsbDeviceIsNull()       { this("Device.this.usbDevice is null."); }
    }

    private static class GetInterfaceFailed extends org.phenoapps.usb.Device.Exception
    {
        private GetInterfaceFailed()
        { super("Device.this.usbDevice.getInterface(0) returned null."); }
    }

    private static class UsbManagerIsNull extends org.phenoapps.usb.Device.Exception
    { private UsbManagerIsNull() { super("Device.this.usbManager is null."); } }

    private static class OpenDeviceFailed extends org.phenoapps.usb.Device.Exception
    {
    ...
    extends org.phenoapps.usb.Device.OpenDeviceFailed
    {
    ...
    {
        return org.phenoapps.androidlibrary.Utils.replaceIfNull(
    ...
    void setUsbDevice(final org.phenoapps.usb.Device device)
    ...
    throws org.phenoapps.usb.Device.Exception
    {
        ...
        {
            if (this.usbDeviceIsNull())
                throw new org.phenoapps.usb.Device.UsbDeviceIsNull();
            else
            {
                if (null == this.usbInterface)
                {
                    ...
                    if (null == this.usbInterface)
                        throw new org.phenoapps.usb.Device.GetInterfaceFailed();
                }
                ...
                if (null == this.usbDeviceConnection)
                {
                    if (null == this.usbManager)
                        throw new org.phenoapps.usb.Device.UsbManagerIsNull();

                    this.usbDeviceConnection = this.usbManager.openDevice(this.usbDevice);
                    if (null == this.usbDeviceConnection)
                        if (this.usbManager.hasPermission(this.usbDevice))
                            throw new org.phenoapps.usb.Device.OpenDeviceFailed();
                        else
                            throw new org.phenoapps.usb.Device.OpenDeviceLacksPermission();
                    else
        ...
        catch (final org.phenoapps.usb.Device.Exception e) { this.close(); throw e; }
    }
    ...
    java.lang.String formattedRead() throws org.phenoapps.usb.Device.Exception
    {
        final int length; final java.lang.String data;
        {
            ...
            data   = org.phenoapps.androidlibrary.Utils.convert(buffer, length);
        }
