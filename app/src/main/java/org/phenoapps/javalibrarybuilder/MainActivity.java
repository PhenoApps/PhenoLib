...
public class MainActivity extends androidx.appcompat.app.AppCompatActivity
{
    ...
    // region Types
    private static class Dir extends org.phenoapps.permissions.Dir
    {
        private Dir(final java.io.File path,
        @androidx.annotation.NonNull final android.app.Activity activity,
        @androidx.annotation.IdRes   final int                  id      )
        {
            super(path, org.phenoapps.javalibrarybuilder.MainActivity.BLANK_HIDDEN_FILE);
    ...
    // region Fields
    private org.phenoapps.javalibrarybuilder.MainActivity.Dir
        internalDir = null, externalPrivateDir = null, externalPublicDir = null;
    private org.phenoapps.javalibrarybuilder.MainActivity.PermissionDir
    ...
    @androidx.annotation.IntRange(
    from = org.phenoapps.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE,
    to   = org.phenoapps.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE)
    private int buttonState = org.phenoapps.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE;
    ...
    private void listAll(final org.phenoapps.permissions.Dir dir)
    {
        if (null != dir)
            try { this.setMultiLineTextViewText(dir.list()); }
            catch (final org.phenoapps.permissions.Dir.PermissionException e)
            { this.setMultiLineTextViewText(e.getMessage()); }
    }

    private void listXml(final org.phenoapps.permissions.Dir dir)
    {
        if (null != dir)
    ...
    @androidx.annotation.NonNull final org.phenoapps.androidlibrary.Utils.Response response)
    {
        if (null == this.intentInstance) this.intentInstance = new android.content.Intent(
            this, org.phenoapps.javalibrarybuilder.WebViewActivity.class);

        return this.intentInstance
            .putExtra(org.phenoapps.javalibrarybuilder.WebViewActivity.CONTENT,
                response.content())
            .putExtra(org.phenoapps.javalibrarybuilder.WebViewActivity.ENCODING,
    ...
    private void makeButtonReflectCurrentButtonState()
    {
        ...
        {
            case org.phenoapps.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE:
            ...
            case org.phenoapps.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE:
    ...
    @java.lang.Override protected void onCreate(final android.os.Bundle savedInstanceState)
    {
        ...
        this.setContentView(org.phenoapps.androidlibrarybuilder.R.layout.activity_main_java);

        {
            final android.widget.TextView adjustTextView = this.findViewById(
                org.phenoapps.androidlibrarybuilder.R.id.adjustTextView);
            if (null != adjustTextView)
            {
                ...
                adjustTextView.setText(java.lang.String.format("adjust(\"%s\") is \"%s\"",
                    unadjusted, org.phenoapps.androidlibrary.Utils.adjust(unadjusted)));
            }
        }

        this.internalDir = new org.phenoapps.javalibrarybuilder.MainActivity.Dir(
            this.getFilesDir(),this,
            org.phenoapps.androidlibrarybuilder.R.id.internalDirTextView);
        this.externalPrivateDir = new org.phenoapps.javalibrarybuilder.MainActivity.Dir(
            this.getExternalFilesDir(null),this,
            org.phenoapps.androidlibrarybuilder.R.id.externalPrivateDirTextView);
        this.externalPublicDir = new org.phenoapps.javalibrarybuilder.MainActivity.Dir(
            android.os.Environment.getExternalStorageDirectory(),this,
            org.phenoapps.androidlibrarybuilder.R.id.externalPublicDirTextView);

        this.internalPermissionDir =
            new org.phenoapps.javalibrarybuilder.MainActivity.PermissionDir(this.getFilesDir());
        this.externalPrivatePermissionDir =
            new org.phenoapps.javalibrarybuilder.MainActivity.PermissionDir(
        ...
        this.multiLineTextView = this.findViewById(
            org.phenoapps.androidlibrarybuilder.R.id.multiLineTextView);

        if (null != savedInstanceState)
        {
            if (savedInstanceState.containsKey(
            org.phenoapps.javalibrarybuilder.MainActivity.BUTTON_STATE_KEY))
            {
                @androidx.annotation.IntRange(
                from = org.phenoapps.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE,
                to   = org.phenoapps.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE) final int
            ...
            if (savedInstanceState.containsKey(
            org.phenoapps.javalibrarybuilder.MainActivity.MULTI_LINE_TEXT_VIEW_TEXT_KEY))
                this.setMultiLineTextViewText(savedInstanceState.getCharSequence(org.phenoapps
    ...
    @androidx.annotation.NonNull final android.os.Bundle outState)
    {
        ...
        outState.putInt(
            org.phenoapps.javalibrarybuilder.MainActivity.BUTTON_STATE_KEY, this.buttonState);
    ...
    public void onButtonClick(@java.lang.SuppressWarnings({"unused"}) final android.view.View view)
    {
        switch (this.buttonState)
        {
            ...
            case 12: case org.phenoapps.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE:
                    ...
                    java.net.URL url;
                    {
                        ...
                        try
                        {
                            switch (this.buttonState)
                            {
                                ...
                                case org.phenoapps.javalibrarybuilder
        ...
        switch (this.buttonState)
        {
            ...
            default: this.buttonState =
                org.phenoapps.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE; break;
        }
        this.makeButtonReflectCurrentButtonState();
    }
}