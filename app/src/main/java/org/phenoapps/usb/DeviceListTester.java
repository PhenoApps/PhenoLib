...
public class DeviceListTester extends java.lang.Object
{
    ...
    private       org.phenoapps.usb.DeviceList deviceListInstance = null;
    // endregion

    private org.phenoapps.usb.DeviceList deviceList()
    {
        if (null == this.deviceListInstance)
            this.deviceListInstance = new org.phenoapps.usb.DeviceList(this.activity);
